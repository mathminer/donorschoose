...
schemaProjects = StructType.fromJson({'fields': [
  ...
  {'metadata': {}, 'name': 'Teacher Project Posted Sequence', 'nullable': True, 'type': 'integer'},
  {'metadata': {}, 'name': 'Project Type', 'nullable': True,'type': 'string'},
  {'metadata': {}, 'name': 'Project Title', 'nullable': True, 'type': 'string'},
  {'metadata': {}, 'name': 'Project Essay', 'nullable': True, 'type': 'string'},
  {'metadata': {}, 'name': 'Project Short Description', 'nullable': True, 'type': 'string'},
  {'metadata': {}, 'name': 'Project Need Statement', 'nullable': True, 'type': 'string'},
  {'metadata': {}, 'name': 'Project Subject Category Tree', 'nullable': True, 'type': 'string'},
  {'metadata': {}, 'name': 'Project Subject Subcategory Tree','nullable': True,   'type': 'string'},
  {'metadata': {}, 'name': 'Project Grade Level Category', 'nullable': True, 'type': 'string'},
  {'metadata': {}, 'name': 'Project Resource Category', 'nullable': True, 'type': 'string'},
  {'metadata': {}, 'name': 'Project Cost', 'nullable': True, 'type': 'float'},
  {'metadata': {}, 'name': 'Project Posted Date', 'nullable': True, 'type': 'date'},
  {'metadata': {}, 'name': 'Project Expiration Date', 'nullable': True, 'type': 'date'},
  {'metadata': {}, 'name': 'Project Current Status', 'nullable': True, 'type': 'string'},
  {'metadata': {}, 'name': 'Project Fully Funded Date', 'nullable': True, 'type': 'date'}],
 'type': 'struct'})
...
df = (spark.read.schema(schemaProjects).format("csv").options(header="true")
     .load(projectsPath))

df.filter(df.School_ID == '438d6b9cad3ab8b82e5303b51a16ee13').show()
